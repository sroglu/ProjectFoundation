...
#pragma warning restore 4014
        ...
        public static bool RunLongLiving(Action job)
        {
            try
            {
#if NETFX_CORE
            ...
            {
                // SystemException throwing when system can't create a new thread
                // so we want catch this exception and return false
                return false;
            }
        }
    }
