...
{
    /// <summary>
    /// Tiny standalone assertion kit for the engine-free Commerce suites — no NUnit, so the pure Core
    /// compiles and runs under mono/csc without Unity, mirroring the RemoteGameConfig / ECS runners.
    /// </summary>
