namespace PFound.ECS
{
    ...
    public sealed partial class World
    {
        public QueryBuilder<T1, T2, T3, T4> Query<T1, T2, T3, T4>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5> Query<T1, T2, T3, T4, T5>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5, T6> Query<T1, T2, T3, T4, T5, T6>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5, T6>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5, T6, T7> Query<T1, T2, T3, T4, T5, T6, T7>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5, T6, T7>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8> Query<T1, T2, T3, T4, T5, T6, T7, T8>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8, T9> Query<T1, T2, T3, T4, T5, T6, T7, T8, T9>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct where T9 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this, inc, default);
        }
        ...
        public QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Query<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct where T9 : struct where T10 : struct
        {
            ...
            return new QueryBuilder<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this, inc, default);
        }

        internal void ForEach<T1, T2, T3, T4>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5, T6>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5, T6> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5, T6, T7>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5, T6, T7> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5, T6, T7, T8>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5, T6, T7, T8> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5, T6, T7, T8, T9>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5, T6, T7, T8, T9> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct where T9 : struct
        {
        ...
        internal void ForEach<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(in ComponentMask inc, in ComponentMask exc, RefAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> action) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct where T7 : struct where T8 : struct where T9 : struct where T10 : struct
        {
